...
export const mondayEntries: TimetableEntry[] = [
  // Cluster A • ETC
  createEntry('Monday', 'A', '09:45 TO 10:45', 'YOGA/I/KM/JSH'),
  createEntry('Monday', 'A', '10:45 TO 11:45', 'BEE/I/SM/C-301'),
  createEntry('Monday', 'A', '11:45 TO 12:45', 'MDC/I/DRN/C-301'),
  createEntry('Monday', 'A', '01:30 TO 03:30', 'EC/I/UT/-A1/CHY LAB'),
  createEntry('Monday', 'A', '01:30 TO 03:30', 'BEE/I/SM/-A2/C-DC MACHINE LAB'),
  createEntry('Monday', 'A', '01:30 TO 03:30', 'DLD/I/PR/-A3/C-303 LAB'),

  // Cluster B • EE
  createEntry('Monday', 'B', '09:45 TO 10:45', 'BEE/I/SM/C-302'),
  ...
  createEntry('Monday', 'B', '03:30 TO 05:30', 'EASP/I/ASK/-B2/DC MACHINE LAB'),
  createEntry('Monday', 'B', '03:30 TO 05:30', 'BE/I/TVR-B3/A-316 LAB'),

  // Cluster C • ME
  createEntry('Monday', 'C', '09:45 TO 10:45', 'MDC/I/SPS/C-304'),
  createEntry('Monday', 'C', '10:45 TO 12:45', 'EM/I/SDC/-C1/C-EM LAB'),
  ...
  createEntry('Monday', 'D', '03:30 TO 05:30', 'EM/I/CG/-D3/C-EM LAB'),

  // Cluster E • AIML
  createEntry('Monday', 'E', '09:45 TO 10:45', 'DLD/I/RW/C-301'),
  createEntry('Monday', 'E', '10:45 TO 11:45', 'YOGA/I/KM/JSH'),
  ...
  createEntry('Monday', 'K', '11:45 TO 12:45', 'YOGA/I/KM/JSH'),
  createEntry('Monday', 'K', '01:30 TO 02:30', 'FDA/I/RK/C-302'),
  ...
  createEntry('Monday', 'K', '03:30 TO 05:30', 'FDA/I/RK/-K3/IT LAB'),
  ...
  // Cluster M • AI-I
  createEntry('Monday', 'M', '09:45 TO 10:45', 'FDA/I/SWP/C-105'),
  createEntry('Monday', 'M', '10:45 TO 11:45', 'LIBRARY'),

...
export const thursdayEntries: TimetableEntry[] = [
  ...
  createEntry('Thursday', 'A', '09:45 TO 11:45', 'M&S/I/TVR/-A3/A-214(B) LAB'),
  ...
  createEntry('Thursday', 'B', '10:45 TO 11:45', 'BEE/I/SM/C-302'),
  createEntry('Thursday', 'B', '11:45 TO 12:45', 'BE/I/TVR/C-302'),
  createEntry('Thursday', 'B', '01:30 TO 03:30', 'BEE/I/SM/-B1/DC MACHINE LAB'),
  createEntry('Thursday', 'B', '01:30 TO 03:30', 'EC/I/UT/-B2/CHY LAB'),
  createEntry('Thursday', 'B', '01:30 TO 03:30', 'EASP/I/ASK/-B3/A-214(A) LAB'),

  // Cluster C • ME
  createEntry('Thursday', 'C', '09:45 TO 10:45', 'YOGA/I/KM/JSH'),
  ...
  createEntry('Thursday', 'C', '03:30 TO 05:30', 'EM/I/SDC/-C3/C-EM LAB'),

  // Cluster D • CE
  createEntry('Thursday', 'D', '09:45 TO 10:45', 'MDC/I/AK/C-401'),
  createEntry('Thursday', 'D', '10:45 TO 12:45', 'EC/I/RDP/-D1/CHY LAB'),
  createEntry('Thursday', 'D', '10:45 TO 12:45', 'EM/I/CG/-D2/C-EM LAB'),
  createEntry('Thursday', 'D', '10:45 TO 12:45', 'CS/I/MS/-D3/C-IT LAB'),
  createEntry('Thursday', 'D', '01:30 TO 03:30', 'EM/I/CG/C-304'),
  ...
  // Cluster F • DS
  createEntry('Thursday', 'F', '09:45 TO 10:45', 'YOGA/I/KM/JSH'),
  ...
  // Cluster G • IT
  createEntry('Thursday', 'G', '09:45 TO 10:45', 'BEE/I/SM/C-303'),
  ...
  createEntry('Thursday', 'H', '09:45 TO 11:45', 'FDA/I/RK/-H2/CE-CAD LAB'),
  ...
  createEntry('Thursday', 'H', '03:30 TO 04:30', 'FDA/I/RK/C-301'),
  ...
  createEntry('Thursday', 'I', '01:30 TO 03:30', 'FDA/I/RK/-I2/C-COM LAB'),
  ...
  createEntry('Thursday', 'J', '11:45 TO 12:45', 'YOGA/I/KM/JSH'),
  ...
  createEntry('Thursday', 'L', '11:45 TO 12:45', 'YOGA/I/KM/JSH'),
  ...
  createEntry('Thursday', 'M', '03:30 TO 05:30', 'FDA/I/SWP/-M1/CE-CAD LAB'),

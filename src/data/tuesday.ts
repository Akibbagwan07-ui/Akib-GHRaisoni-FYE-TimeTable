...
export const tuesdayEntries: TimetableEntry[] = [
  ...
  createEntry('Tuesday', 'A', '11:45 TO 12:45', 'BEE/I/EE1/C-402'),
  createEntry('Tuesday', 'A', '01:30 TO 02:30', 'LIBRARY'),
  createEntry('Tuesday', 'A', '02:30 TO 03:30', 'MDC/I/DRN/C-305'),
  createEntry('Tuesday', 'A', '03:30 TO 05:30', 'BEE/I/EE1/-A1/A-214(A) LAB'),
  ...
  createEntry('Tuesday', 'B', '10:45 TO 11:45', 'BEE/I/EE1/C-302'),
  ...
  // Cluster C
  createEntry('Tuesday', 'C', '10:45 TO 11:45', 'EM/I/CE2/C-403'),
  ...
  // Cluster E
  createEntry('Tuesday', 'E', '09:45 TO 11:45', 'DLD/I/RW/-E1/A-303 LAB'),
  createEntry('Tuesday', 'E', '09:45 TO 11:45', 'EC/I/SK/-E2/CHY LAB'),
  createEntry('Tuesday', 'E', '09:45 TO 11:45', 'CP/I/SBD/-E3/C-COM LAB'),
  createEntry('Tuesday', 'E', '11:45 TO 12:45', 'DLD/I/RW/C-401'),
  ...
  createEntry('Tuesday', 'G', '01:30 TO 03:30', 'BEE/I/EE1/-G3/DC MACHINE LAB'),

  // Cluster H
  createEntry('Tuesday', 'H', '10:45 TO 11:45', 'LAS/I/DRN/C-301'),
  createEntry('Tuesday', 'H', '11:45 TO 12:45', 'PPS/I/SC/C-301'),
  createEntry('Tuesday', 'H', '01:30 TO 02:30', 'FDA/I/CE1/C-303'),

  // Cluster I
  createEntry('Tuesday', 'I', '09:45 TO 10:45', 'FDA/I/CE1/C-305'),
  createEntry('Tuesday', 'I', '10:45 TO 11:45', 'LIBRARY'),
  ...
  createEntry('Tuesday', 'K', '01:30 TO 03:30', 'FDA/I/CE2/-K1/C-COM LAB'),
  ...
  createEntry('Tuesday', 'M', '10:45 TO 12:45', 'FDA/I/CE1/-M2/C-COM LAB'),
  ...
  createEntry('Tuesday', 'N', '11:45 TO 12:45', 'LIBRARY'),
